...
if SERVER or (CLIENT and not file.Exists("sound/vo/announcer_begins_1sec.wav", "MOD")) then
...
if SERVER or (CLIENT and not file.Exists("sound/player/crit_hit.wav", "MOD")) then
